...
import 'package:heal_care/core/theme/app_text_styles.dart' show AppTextStyles;
                            ...
                            Row(
                              children: [
                                ...
                                InkWell(
                                  ...
                                  child: Text(
                                    'Edit',
                                    style: AppTextStyles.poppinsMainColor(12, FontWeight.w400),
                                  ),
                            ...
                            BlocBuilder<ProfileCubit, ProfileState>(
                              ...
                              builder: (context, state) {
                                ...
                                if (state is DoctorScheduleSuccess) {
                                  return WorkingHoursWidget(schedule: state.schedule.days);
                                }
